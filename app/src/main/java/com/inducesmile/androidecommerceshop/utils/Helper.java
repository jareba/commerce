...
public class Helper {
    ...
    public static final String PUBLIC_FOLDER = "http://timisha-solutions.com/apps/public/";
    public static final String PUBLIC_API_FOLDER = "http://timisha-solutions.com/apps/public/api/";
